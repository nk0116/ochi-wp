        ...
        <div class="fv-low">
          <div class="fv-low__inner">
            ...
            <div class="fv-low__titles">
              ...
              <p class="fv-low__titles--text">アクセス</p>
            </div>
          </div>
...
<!--                   <li>
        ...
        <!-- <section class="gallery-low">
          <div class="low-titles">
            <h3 class="low-title">Gallery</h3>
            <p class="low-title__text">クリニック写真</p>
          </div>

          <div class="gallery-low__inner">
            <div class="swiper gallery-low-swiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/access/gallery01.png" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/access/gallery02.png" alt="">
                </div>
                <div class="swiper-slide">
                  <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/access/gallery01.png" alt="">
                </div>
              ...
              <div class="gallery-low-swiper__btn">
                ...
                <button class="gallery-low-next">
                  <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/access/btn-next.svg" alt="">
                </button>
              </div>
            </div>
          </div>
