                ...
                <div class="contact__clinic-info">
                  <div class="contact__reservations">
                    <a
                      ...
                      href="<?php echo esc_url( home_url('https://page.line.me/wdy1996b') ); ?>"
                      target="_blank"
                    ...
                    <a
                      class="contact__reservation"
                      href="<?php echo esc_url( home_url('https://cosmedical.jp/contact/') ); ?>"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <p class="contact__reservation-title">
              ...
              <div class="contact__clinic">
                ...
                <div class="contact__clinic-info">
                  <div class="contact__reservations">
                    <a
                      class="contact__reservation"
                      href="<?php echo esc_url( home_url('https://line.me/R/ti/p/%40400hhfgq') ); ?>"
                    >
                      <p class="contact__reservation-title">
                        <img
                    ...
                    <a
                      class="contact__reservation"
                      href="<?php echo esc_url( home_url('https://www.cancer-chika.jp/reservation/shibuya') ); ?>"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <p class="contact__reservation-title">
