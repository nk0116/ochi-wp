...
<main>
        ...
        <nav class="breadcrumb" aria-label="パンくずリスト">
          <ol class="breadcrumb__list">
            ...
            <li class="breadcrumb__item breadcrumb__item--current" aria-current="page">
              <a href="<?php echo esc_url( home_url('') ); ?>" class="breadcrumb__link">症例紹介一覧</a>
            </li>
            <li><span>/</span></li>
            <li class="breadcrumb__item breadcrumb__item--current" aria-current="page">
              <span class="current-page">症例紹介</span>
            </li>
          </ol>
        </nav>
        <!-- パンくずリスト -->
        ...
        <section class="case-detail">
          <div class="case-detail__inner">
            <div class="case-detail__inner--left">
            ...
            <div class="case-detail__inner--right">
              <div class="case-item">
                <p class="case-item__title">施術名</p>
                <p class="case-item__content">タイトルが入ります</p>
              </div>
              <div class="case-item">
                <p class="case-item__title">施術内容</p>
                <p class="case-item__content">テキストが入ります。テキストが入ります。テキストが入ります。テキストが入ります。</p>
              </div>
              <div class="case-item">
                <p class="case-item__title">費用目安</p>
                <p class="case-item__content">￥00,000(税込)</p>
              </div>
              <div class="case-item">
                <p class="case-item__title">年代</p>
                <p class="case-item__content">00代</p>
              </div>
              <div class="case-item">
                <p class="case-item__title">リスク・副作用</p>
                <p class="case-item__content">リスク・副作用が入ります。リスク・副作用が入ります。</p>
              </div>
              <div class="case-item">
                <p class="case-item__title">更新日</p>
                <p class="case-item__content">2024年12月20日</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="related-links">
          <div class="inner">
            <div class="related-links__content">
              <a href="<?php echo esc_url( home_url('treatment-list') ); ?>" class="btn">施術一覧へ</a>
              <a href="<?php echo esc_url( home_url('price-list') ); ?>" class="btn">料金表へ</a>
            </div>
          </div>
        </section>

        <section class="doctor-profile">
          <div class="doctor-profile__inner">
            <div class="doctor-profile__area">
              <div class="doctor-profile__title">
                <h2>記事監修者プロフィール</h2>
              </div>
              <div class="doctor-profile__content">
                <div class="doctor-profile__left">
                  <p class="doctor-profile__left__clinic">コスメディカルクリニックシンシア　総院長　</p>
                  <p class="doctor-profile__left__post">銀座院院長</p>
                  <p class="doctor-profile__left__name">又吉 秀樹</p>
                  <p class="doctor-profile__left__roman">Hideki Matayoshi</p>
                  <div class="doctor-profile__left__sns">
                    <a href="" target="_blank" class="doctor-profile__left__sns--instagram">
                      <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/staff/icon-instagram.png" alt="" width="20" height="20">
                    </a>
                    <a href="" target="_blank" class="doctor-profile__left__sns--x">
                      <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/staff/icon-x.png" alt="" width="18" height="18">
                    </a>
                    <a href="" target="_blank" class="doctor-profile__left__sns--youtube">
                      <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/staff/icon-youtube.png" alt="" width="28" height="20">
                    </a>
                  </div>
                  <div class="doctor-profile__left__img">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/column/doctor-matayoshi.png" alt="" width="360" height="400">
                  </div>
                </div>
                <div class="doctor-profile__right">
                  <div class="doctor-profile__right__career">
                    <p class="doctor-profile__right__career--title">経歴</p>
                    <ul>
                  ...
                  <div class="doctor-profile__right__info">
                    <p class="doctor-profile__right__info--title">資格・所属学会</p>
                    <ul>
