          ...
          <div class="notice-list__inner">
            <div class="notice-list__body">
              <div class="notice-list__content">
                ...
                <div class="notice-list__item">
                  <div class="notice-list__image">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/notice/notice02.jpg" alt="" />
                  </div>
                ...
                <div class="notice-list__item">
                  <div class="notice-list__image">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/notice/notice03.jpg" alt="" />
                  </div>
                ...
                <div class="notice-list__item">
                  <div class="notice-list__image">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/notice/notice04.jpg" alt="" />
                  </div>
                ...
                <div class="notice-list__item">
                  <div class="notice-list__image">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/notice/notice05.jpg" alt="" />
                  </div>
                ...
                <div class="notice-list__item">
                  <div class="notice-list__image">
                    <img src="<?php bloginfo( 'stylesheet_directory' ); ?>/img/notice/notice06.jpg" alt="" />
                  </div>
            ...
            <div class="notice-list__side">
              <div class="notice-list__category__area">
                ...
                <div class="notice-list__category__list">
                  <h2>Category</h2>
                  <ul>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>テキスト</span></a></li>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>テキスト</span></a></li>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>テキスト</span></a></li>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>テキスト</span></a></li>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>シミ・肝斑</span></a></li>
                    <li><a href="<?php echo esc_url( home_url('') ); ?>"><span>ピーリング</span></a></li>
                  </ul>
                </div>
              </div>
              </div>
