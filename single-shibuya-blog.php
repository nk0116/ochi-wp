  ...
  <div class="fv-low">
    <div class="fv-low__inner">
      <div class="fv-low__titles">
        ...
        <p class="fv-low__titles--text">渋谷院　ブログ</p>
      </div>
    </div>
  </div>
    ...
    <div class="inner">
      <div class="blog-detail__inner">
          ...
          <div class="table-of-contents">
            <ol class="wp-block-list">
              ...
              if (!empty($matches)) {
                ...
                // 見出しがない場合はデフォルトの目次を表示
                echo '<li>';
                echo '<a href="#"><b>1. 中見出しがはいります</b></a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '</li>';
                echo '<li>';
                echo '<a href="#"><b>2. 中見出しがはいります</b></a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '</li>';
                echo '<li>';
                echo '<a href="#"><b>3. 中見出しがはいります</b></a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '<a href="#">小見出しがはいります</a>';
                echo '</li>';
              }
        ...
        <div class="blog-detail__box">
          ...
          <div class="blog-foot">
            <a href="<?php echo esc_url(get_post_type_archive_link('shibuya-blog')); ?>" class="btn__back">
              <span>一覧に戻る</span>
            </a>
          </div>
        </div>
